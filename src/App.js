...
class App extends Component {
  ...
  render() {
    ...
    return (      
      <BrowserRouter>
        <>
          <CookieConsent location="bottom" cookieName="ciasteczka" expires={365} overlay buttonText="Rozumiem, przejdz dalej" flipButtons="true" contentStyle={myContentStyle}>
            Ta strona używa plików cookie, aby uzyskać szczegółowe informacje na temat przetwarzania Twoich danych osobowych, znajdują się one w <a className="cookie" href="/privacy">polityce prywatności</a>.
          </CookieConsent>
          <Header />          
          ...
          <Switch>
            ...
            <Route path="/about" component={AboutComponent} variants={pageVariants} transition={pageTransition}/>

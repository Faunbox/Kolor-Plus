      ...
      >
        <div className="color">
          ...
          <p className="color">
            {" "}
            <strong>
              W naszym sklepie specjalizujemy się w doborze lakierów
              samochodowych.
            </strong>
            <br /> Z doświadczenia wiemy, że do każdego lakieru trzeba podejść
            indywidualnie.
            <br /> Numer koloru jest pomocny ale nie gwarantuje dobrze dobranego
            koloru. Dorobienie lakieru to odpowiedzialność po obu stronach,
            zarówno naszej jak i klienta. Zawsze prosimy o element samochodu
            bądź wycięty kawałek, ewentualnie zostawienie nam samochodu na
            parkingu na określony czas. Klient powinien również zwrócić uwagę
            czy przyniesiony element nie był już wcześniej
            lakierowany/cieniowany, gdyż może to prowadzić do pomyłki przy
            dobieraniu odcienia.
          </p>
        </div>
        <div className="color">
          ...
          <p className="color first">
            <strong>Posiadamy ogromną bazę receptur z całego świata,</strong>{" "}
            która codziennie w czasie rzeczywistym jest uaktualniana i
            poszerzana poprzez stałe połączenie z chmurą. Mamy receptury na
            prawie każdy kolor samochodowy (w tym Mazda 46V, Mazda 46G,
            Mitsubishi P62), większość przemysłowych a także wiele
            motocyklowych.
          </p>
        </div>
        <div className="color">
